...
namespace Sigma.Core.Monitors.WPF.View.Factories.Defaults.StatusBar
{
	...
	public class TaskVisualizerFactory : IUIFactory<UIElement>
	{
		...
		///     A factory that produces a <see cref="Label" /> with the <see cref="Style" /> "ShowMoreIndicator" and the content
		///     "..." will be used
		...
		/// <summary>
		///     Create a <see cref="TaskVisualizerFactory" /> with the given amount of <see cref="maxElements" />.
		///     A factory that produces a <see cref="Label" /> with the <see cref="Style" /> "ShowMoreIndicator" and
		///     <see cref="content" /> will be used
		///     for the creation of the "show more indicator".
		/// </summary>
		/// <param name="maxElements">The amount of maximum <see cref="CustomControls.StatusBar.TaskVisualizer" />.</param>
		/// <param name="content">The content for the <see cref="Label" />.</param>
		public TaskVisualizerFactory(int maxElements, object content)
			: this(maxElements, Application.Current.Resources["ShowMoreIndicator"] as Style, content)
		{
		}

		/// <summary>
		///     Create a <see cref="TaskVisualizerFactory" /> with the given amount of <see cref="maxElements" />.
		///     A factory that produces a <see cref="Label" /> with a given <see cref="labelStyle" /> and <see cref="content" />
		///     will be used
		///     for the creation of the "show more indicator".
		/// </summary>
		/// <param name="maxElements">The amount of maximum <see cref="CustomControls.StatusBar.TaskVisualizer" />.</param>
		...
		/// <param name="content">The content for the <see cref="Label" />.</param>
		public TaskVisualizerFactory(int maxElements, Style labelStyle, object content)
			: this(maxElements, new ShowMoreFactory(labelStyle, content))
		{
		}
