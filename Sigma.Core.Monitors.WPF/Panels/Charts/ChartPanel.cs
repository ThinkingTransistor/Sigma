...
namespace Sigma.Core.Monitors.WPF.Panels.Charts
{
		...
		where TChart : Chart, new() where TSeries : Series, new() where TChartValues : IChartValues, ICollection<TData>, new()
	{
		...
		///// <summary>
		///// The min value of the x-axis. Changing this will not affect the UI.
		///// </summary>
		//private double _axisXMin;

		///// <summary>
		///// The max value of the x-axis. Changing this will not affect the UI.
		///// </summary>
		//private double _axisXMax;

		///// <summary>
		///// The min value of the y-axis. Changing this will not affect the UI.
		///// </summary>
		//private double _axisYMin;

		///// <summary>
		///// The max value of the y-axis. Changing this will not affect the UI.
		///// </summary>
		//private double _axisYMax;

		///// <summary>
		///// The max value of the x-axis bound with the UI. (set from any thread)
		///// </summary>
		...
		///// <summary>
		///// The max value of the y-axis bound with the UI. (set from any thread)
		///// </summary>
		...
		///// <summary>
		///// The min value of the x-axis bound with the UI. (set from any thread)
		///// </summary>
		...
		///// <summary>
		///// The min value of the y-axis bound with the UI. (set from any thread)
		///// </summary>
