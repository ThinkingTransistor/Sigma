...
namespace Sigma.Core.Monitors.WPF.Panels.Optimisations
{
	...
	/// </summary>
	public abstract class TargetMaximisationPanel : BitmapPanel
	{
		/// <summary>
		...
		public class VisualTargetMaximisationReporter : TargetMaximisationReporter
		{
			...
			public VisualTargetMaximisationReporter(TargetMaximisationPanel panel, INDArray desiredTargets, ITimeStep timestep) : this(panel, desiredTargets, 0.05, timestep)
			{ }
			...
			/// <param name="desiredCost">The desired cost.</param>
			/// <param name="timestep">The timestep this hook executes on.</param>
			public VisualTargetMaximisationReporter(TargetMaximisationPanel panel, INDArray desiredTargets, double desiredCost, ITimeStep timestep) : this(desiredTargets, desiredCost, timestep)
			{
				SetPanel(panel);
			}
			...
			public void SetPanel(TargetMaximisationPanel panel)
			{
			...
			{
				TargetMaximisationPanel panel = (TargetMaximisationPanel)ParameterRegistry[TargetPanel];
		...
		protected TargetMaximisationPanel(string title, int inputWidth, int inputHeight, object headerContent = null)
		...
		protected TargetMaximisationPanel(string title, int inputWidth, int inputHeight, IHook hook, ITrainer trainer, object headerContent = null)
