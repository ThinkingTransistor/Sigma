...
namespace Sigma.Core.Training.Hooks.Reporters
{
	...
	/// </summary>
	[Serializable]
	public class ValueReporter : BaseHook
	{
		[NonSerialized]
		...
		public ValueReporter(string valueIdentifier, ITimeStep timestep, bool reportEpochIteration = false) : this(new[] { valueIdentifier }, timestep, reportEpochIteration: reportEpochIteration) { }
		...
		public ValueReporter(string valueIdentifier, ITimeStep timestep, ExtremaTarget target) : this(new[] { valueIdentifier }, timestep)
		{
		...
		public ValueReporter(string valueIdentifier, ITimeStep timestep, double threshold, ComparisonTarget target, bool fireContinously = true) : this(new[] { valueIdentifier }, timestep)
		{
