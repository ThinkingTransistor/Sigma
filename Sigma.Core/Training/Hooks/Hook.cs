...
namespace Sigma.Core.Training.Hooks
{
	...
	public abstract class ActiveHook : Hook, IActiveHook
	{
		...
		protected ActiveHook(ITimeStep timestep, params string[] requiredRegistryEntries) : base(timestep, requiredRegistryEntries)
		{
		}
	...
	public abstract class PassiveHook : Hook, IPassiveHook
	{
		...
		/// <param name="timestep">The time step.</param>
		/// <param name="requiredRegistryEntries">The set of required global registry entries.</param>
		protected PassiveHook(ITimeStep timestep, params string[] requiredRegistryEntries) : base(timestep, requiredRegistryEntries)
		{
		}
	...
	/// </summary>
	public abstract class Command : ActiveHook, ICommand
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="requiredRegistryEntries">The required global registry entries.</param>
		protected Command(params string[] requiredRegistryEntries) : base(TimeStepCommand, requiredRegistryEntries)
		{
		}
		...
		/// </summary>
		/// <param name="requiredRegistryEntries">The required global registry entries.</param>
		protected Command(ISet<string> requiredRegistryEntries) : base(TimeStepCommand, requiredRegistryEntries)
		{
		}
	}
}
